// Toutes les infos du portfolio sont ici : modifie ce fichier pour mettre
// à jour les projets, les compétences ou les textes, sans toucher au reste du code.
...
export const timeline = {
  fr: [
    ...
    { t: "Développeur Full Stack", s: "En alternance — Reconomia, Groupe Boulanger" },
  ],
  en: [
    { t: "Bus Driver", s: "10 years — Keolis Nord / TADAO" },
    { t: "Career switch", s: "Full Stack Developer Bachelor's (RNCP 38606)" },
    { t: "Full Stack Developer", s: "Apprenticeship — Reconomia, Groupe Boulanger" },
  ],
};
...
export const T = {
  fr: {
    ...
    heroDesc:
      "En alternance chez Reconomia (Groupe Boulanger). Je construis des parcours numériques qui tiennent la route, du premier commit à la mise en production.",
    ctaProjects: "Voir mes projets",
    ctaContact: "Me contacter",
    stop1: "ARRÊT 01",
    aboutTitle: "À propos",
    aboutBody:
      "Avant de coder, j'ai piloté pendant plus de dix ans les lignes de deux réseaux de transport, en Métropole Lilloise. J'y ai appris à tenir un itinéraire, à gérer l'imprévu en temps réel et à livrer, jour après jour. Aujourd'hui je code avec la même exigence : construire, ligne par ligne, des produits qui tiennent la route.",
    stop2: "ARRÊT 02",
  ...
  en: {
    ...
    heroDesc:
      "Apprentice developer at Reconomia (Groupe Boulanger). I build digital journeys that hold the road, from first commit to production.",
    ctaProjects: "See my projects",
    ctaContact: "Get in touch",
    stop1: "STOP 01",
    aboutTitle: "About",
    aboutBody:
      "Before I wrote code, I spent over ten years driving bus routes for two transport networks in the Lille metropolitan area. I learned to hold a schedule, handle the unexpected in real time, and deliver, day after day. I code with the same standard now: building, line by line, products that hold the road.",
    stop2: "STOP 02",
    skillsTitle: "Skills",
    stop3: "STOP 03",
